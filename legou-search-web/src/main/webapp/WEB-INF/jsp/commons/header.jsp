...
<div id="header">
  <div class="header_inner">
    <div class="logo">
			<a name="sfbest_hp_hp_head_logo" href="http://www.legou.com" class="trackref logoleft">
		</a>
			<div class="logo-text">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://cart.legou.com" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
